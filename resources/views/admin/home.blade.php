...
<div class="row">
        ...
        <div class="p-3 bg-success-300 rounded overflow-hidden position-relative text-white mb-g">
            <div class="">
                <h3 class="display-4 d-block l-h-n m-0 fw-500">
                    {{ $data->total_cook }}
                    <small class="m-0 l-h-n">Total Chef's</small>
                </h3>
            </div>
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="p-3 bg-warning-400 rounded overflow-hidden position-relative text-white mb-g">
            <div class="">
                <h3 class="display-4 d-block l-h-n m-0 fw-500">
                     {{ $data->total_learn }} 
                    <small class="m-0 l-h-n">Total Learners</small>
                </h3>
            </div>
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="p-3 bg-danger-200 rounded overflow-hidden position-relative text-white mb-g">
            <div class="">
                <h3 class="display-4 d-block l-h-n m-0 fw-500">
                     {{ $data->total_videos }} 
                    <small class="m-0 l-h-n">Total Videos</small>
                </h3>
            </div>
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="p-3 bg-info-200 rounded overflow-hidden position-relative text-white mb-g">
            <div class="">
                <h3 class="display-4 d-block l-h-n m-0 fw-500">
                    {{ $data->total_food_category }} 
                    <small class="m-0 l-h-n">Total Food Category</small>
                </h3>
            </div>
            <i class="fal fa-cheeseburger position-absolute pos-right pos-bottom opacity-15 mb-n1 mr-n4" style="font-size: 6rem;"></i>
        </div>
    </div>
</div>
<div class="row">
