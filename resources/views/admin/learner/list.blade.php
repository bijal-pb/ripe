...
<div class="subheader">
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-burger-soda'></i> Learner <span class='fw-300'></span> <sup class='badge badge-primary fw-500'></sup>
        {{-- <small>
...
<div class="row">
    <div class="col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>
                Learner <span class="fw-300"><i></i></span>
                </h2>
            ...
            <div class="panel-container show">
                ...
                <div class="panel-content" >
                    <div id="categoryData">
                        <table id="learner-table" class="table table-bordered table-hover table-striped w-100 dataTable dtr-inline">
...
<script type="text/javascript">
    $(document).ready(function(){
        var table =  $('#learner-table').DataTable(
                {
                    responsive: true,
                    serverSide: true,
                    ajax: "{{ route('admin.learner.list') }}",
                    columns: [
                        {data: 'id', name: 'Id'},
                        {data: 'name', name: 'Name'},
        ...
        $('#catForm').submit(function(e) {
            ...
            var ajaxurl = "{{ route('admin.learner.store') }}";
            if(pass === confirm)
            {
                $.ajax({
                type:'POST',
