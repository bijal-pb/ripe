...
<head>
  ...
  <!-- Favicons -->
  <link href="{{ URL::asset('admin_assets/img/favicon/favicon.ico')}}" rel="icon">
...
<body>
  ...
  <header id="header" class="fixed-top  header-transparent ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <a href="/"><img src= "{{ URL::asset('admin_assets/img/logo.png')}}" width="100px" alt="RIPE" aria-roledescription="logo"></a>
